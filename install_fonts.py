...
print()
if all_ok:
    print("✅  All fonts installed. Run:  panel serve app.py")
else:
    print("⚠️  Some fonts failed — Markly will use system fallback fonts (italic serif).")
    print("    Annotations will still work, just won't look as handwritten.")
    print("    Run:  panel serve app.py")